OC.L10N.register(
    ...
    "The mobile app is available via your device's official app store." : "The mobile app is available via your device's official app store.",
    "After successful installation try the button again." : "After successful installation try the button again.",
    "Still not working?<br>Copy the link below and paste it into the input field on the Jitsi App start screen.<br>" : "Still not working?<br>Copy the link below and paste it into the input field on the Jitsi App start screen.<br>",
